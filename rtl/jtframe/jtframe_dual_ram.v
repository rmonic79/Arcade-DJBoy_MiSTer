...
//         end else begin
            ...
            // Explicit zero-init to ensure VRAM starts clear on FPGA power-on.
            // Necessary on Cyclone V Lite where M10K default init is not always zero.
            integer init_i;
            initial for (init_i = 0; init_i < (1<<AW); init_i = init_i + 1) mem[init_i] = {DW{1'b0}};
